/* Modified by @FMarquesPTO. All rights reserved. */
...
void main(in PS_Input PSInput, out PS_Output PSOutput)
{
	...
	float4 someJavaHurtColor = PSInput.overlayColor * 0.45;
	color.rgb = lerp( color, someJavaHurtColor, PSInput.overlayColor.a * 0.7).rgb;
#endif
